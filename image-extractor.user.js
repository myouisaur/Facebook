...
(function () {
  ...
  function addButtons(imgEl, filename, isStory = false) {
    ...
    // --- Added: mark parent for hover fade behavior (only for photos/feed) ---
...
// @icon         https://static.xx.fbcdn.net/rsrc.php/y1/r/ay1hV6OlegS.ico
// @version      2.1
// @description  Adds open + download buttons to Facebook images when viewing /photo or /stories. Keeps JPG/JPEG originals, converts PNG/WEBP → JPG (0.92 quality). Smooth fade for feed/photo viewer buttons on image hover only (stories always visible).
// @author       Xiv
// @match        *://*.facebook.com/*
// @grant        GM_addStyle
// @updateURL    https://myouisaur.github.io/Facebook/image-extractor.user.js
